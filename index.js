...
function createMenuItem(itemName, itemPrice, itemMeal){
  const menuItem = {
    name: itemName,
    price: itemPrice,
    category: itemMeal,
...
*/
console.log('task 1b:',createMenuItem('pizza', 5, 'Lunch'), createMenuItem('salad', 3, 'Lunch'), createMenuItem('BLT', 5, "Lunch"));
...
function addReview(array,reviewName,reviewRating,reviewFeedback){
  array.push({name: reviewName, rating:reviewRating, feedback:reviewFeedback});
  return array
}
